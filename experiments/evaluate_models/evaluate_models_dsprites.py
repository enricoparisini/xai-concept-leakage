...
if __name__ == '__main__':
    ...
    results_folder = master_folder + "results/dsprites_dep_0_models/" 
    save_path = master_folder + "results/results_dsprites_dep_0.dict" 
    repeats = 5
    rerun = True
    ...
    path_dataset = DATASETS_DIR + f"dsprites_dep_{corr}.npz"

    train_dl, val_dl, test_dl = dsprites_dataloaders(path_dataset, val_ratio = 0.1, num_workers = 8, 
                                                    batch_size = 256)
