...
if __name__ == '__main__':
    ...
    save_folder = data_folder + "tabulartoy_" + str(int(cov*100)) + "_" + str(int(n_samples//1000)) + "k/"

    train_dl, val_dl, test_dl = TT_dataloaders(save_folder, considered_concepts = considered_concepts,
                                            c_logits = False)
