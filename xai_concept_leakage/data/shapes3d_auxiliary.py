...
def balanced_multiclass_task_bin_concepts_label_fn_equivalent(concept_dict):
    ...
    return (1-concept_vector[4]) * (2*concept_vector[0] + concept_vector[1])    \
    + concept_vector[4] * (4*concept_vector[2] + 2*concept_vector[3] + concept_vector[5] + 4)
...
def shapes3d_dataloaders(path_dataset, 
